        ...
        while (i < fileLines.length) {
            ...
            if (!line.startsWith("#")) {
                if (line.contains("Name=")) {
                    ...
                    setShapeLightTicks(Integer.valueOf(line.split("=")[1]).intValue());
                } else if (line.contains("WOOSH_TICKS=") && line.split("=").length > 1) {
                    setShapeWooshTicks(Integer.valueOf(line.split("=")[1]).intValue());
                } else if (line.startsWith("REDSTONE_ACTIVATED=") && line.split("=").length > 1) {
                    setShapeRedstoneActivated(Boolean.valueOf(line.split("=")[1]).booleanValue());
                }
            }
            i++;
        }
